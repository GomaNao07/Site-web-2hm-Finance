...
| Code Hexadécimal | Nom du Token / CSS Variable | Description & Utilisation |
| :---: | :--- | :--- |
...
| **`#3A2E38`** | `N/A` | **Gris Encre** — Texte secondaire et corps de paragraphe sur les blocs clairs. |
...
| Code Hexadécimal | Description & Utilisation |
| :---: | :--- |
